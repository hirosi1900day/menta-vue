...
const bookmarkOn = async () => {
    try {
        ...
        const res = await axios.post(`http://localhost:3000/api/v1/bookmarks`, formData, {
            headers: {
...
const addComment = async () => {
    try {
        ...
        const res = await axios.post(`http://localhost:3000/api/v1/comments/knowledge`, formData, {
            headers: {
                'access-token' : Cookies.get('accessToken'),
                'client':Cookies.get('client'),
                'uid': Cookies.get('uid')
